...
export default function PaginaCategoriasList() {
  ...
  async function excluir(categoria) {
    if (!confirm(`Apagar "${categoria.name}"? As páginas dela ficam sem categoria (não são apagadas).`)) return
  ...
  return (
    <div className="max-w-xl">
      ...
      <p className="mt-1 text-sm text-mist">
        Agrupam páginas visualmente (ex: Grupos WhatsApp, Termos e Intermediação). Pra aparecer no menu do
        site, adicione a categoria em <a href="/admin/menu" className="underline">Menu do site</a>.
      </p>
