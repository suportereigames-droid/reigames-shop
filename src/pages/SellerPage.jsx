...
function LinhaComSetas({ children }) {
  return (
    <div
      className="-mx-4 flex gap-3 overflow-x-auto px-4 pb-2 scroll-smooth"
...
export default function SellerPage() {
  ...
  // Só mostra categorias que têm pelo menos uma conta desse vendedor —
  // mesma regra da home.
  ...
  // Mesma regra pra subcategoria: só aparece se tiver conta dela dentro
